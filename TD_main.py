...
input_pose_data_path = "D:/datasets/BIWI/db_annotations"
...
#----------------------------------------------------- Args --------------------------------------------------
use_landmark_or_rotation = 0  # 0 mean use landmark to create the tensor  |  1 means use rotation matrix to create the tensor
...
plot_factor_matrices_dims = True
#-------------------------------------------------------------------------------------------------------------

if use_landmark_or_rotation == 0:
...
if os.path.exists(tensor_file):
    ...
    composition_tensor, empty_entry = CreateTensor.Compose_Tensor(input_image_path, tensor_shape,
                                                            yaw_bins, pitch_bins, roll_bins, identities, use_landmark_or_rotation)
